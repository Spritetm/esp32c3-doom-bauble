...
#define Z_Malloc(sz, tag, ptr) Z_Malloc_verbose(sz, tag, ptr, __FUNCTION__, __LINE__)
void *(Z_Malloc_verbose)(size_t size, int tag, void **ptr DA(const char *, int), const char *fn, int line);
